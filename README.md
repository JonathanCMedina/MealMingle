...
| DELETE | http://localhost:8000/docs#/events/delete_event_events**event_id**delete | Backend endpoint for deleting one event |
...
![Delete Endpoint](Images/mealmingle-delete-endpoint.png "Screenshot of delete an event backend endpoint for Meal Mingle")
...
![GET Endpoint](Images/mealmingle-get-all-foods.png "Screenshot of get all foods backend endpoint for Meal Mingle")
...
![Unit Tests](Images/mealmingle-pytest.png "Screenshot of get unit tests passing for Meal Mingle")
...
![Create Event Frontend](Images/mealmingle-event-form.png "Screenshot of creating event in frontend for Meal Mingle")
...
![Invite to Event](Images/mealmingle-invite-frontend.png "Screenshot of sending an invite to an event for Meal Mingle")
...
![Frontend Authentication](Images/mealmingle-frontend-auth-imports.png "Screenshot of frontend authentication examples for Meal Mingle")

![Frontend Authentication](Images/mealmingle-frontend-auth-useeffect.png "Screenshot of frontend authentication examples for Meal Mingle")
...
![Frontend Deployment](Images/mealmingle-frontend-deploy-appjs.png "Screenshot of app.js for frontend auth for Meal Mingle")
...
![Frontend Deployment](Images/mealmingle-gitlabyaml-links.png "Screenshot of app.js for frontend auth for Meal Mingle")
...
![Frontend Deployment](Images/mealmingle-main-allowed.png "Screenshot of app.js for frontend auth for Meal Mingle")
