...
const LandingPage = (props) => {
    return (
        <div className="landing-page p-7 relative w-100% h-100% overflow-hidden bg-cover bg-[100%] bg-no-repeat bg-black bg-center relative">
            <img src = {landingImage} className = "w-full h-full object-cover" alt="Picture of a variety of people gathered around an outdoor table enjoying a meal together"/>
